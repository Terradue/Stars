...
namespace Kajabity.Tools.Java
{
    ...
    /// </summary>
    public class JavaProperties : NameValueCollection
    {
        /// <summary>
        ...
        /// </summary>
        protected NameValueCollection defaults;
        ...
        public JavaProperties(NameValueCollection defaults)
        {
        ...
        {
            NameValueCollection combined;
            if (defaults != null)
            {
                combined = new NameValueCollection(defaults);
            ...
            {
                combined = new NameValueCollection(this);
            }
